...
namespace Backend.Migrations
{
    ...
    [Migration("20240913125613_ChangesDateTimeToLongForCompatibility")]
    partial class ChangesDateTimeToLongForCompatibility
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Backend.Models.Mail", b =>
                {
                    ...
                    b.HasIndex("Subject", "Body")
                        .HasAnnotation("Npgsql:CreatedConcurrently", true);

                    NpgsqlIndexBuilderExtensions.HasMethod(b.HasIndex("Subject", "Body"), "GIN");
                    NpgsqlIndexBuilderExtensions.HasOperators(b.HasIndex("Subject", "Body"), new[] { "gin_trgm_ops" });
