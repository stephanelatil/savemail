...
namespace Backend.Migrations
{
    ...
    [Migration("20250311083102_MakesLastPulledIfNullableToAvoidDupicatesOnMailsWithUidOf1")]
    partial class MakesLastPulledIfNullableToAvoidDupicatesOnMailsWithUidOf1
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Backend.Models.Folder", b =>
                {
                    ...
                    b.Property<decimal?>("LastPulledUid")
            ...
            modelBuilder.Entity("Backend.Models.Mail", b =>
                {
                    ...
                    b.Property<decimal>("ImapMailUID")
                        .HasColumnType("numeric(20,0)");
                    ...
                    b.Property<NpgsqlTsVector>("SearchVector")
                        ...
                        .HasAnnotation("Npgsql:TsVectorProperties", new[] { "Subject", "BodyText" });
                    ...
                    b.Property<decimal>("UniqueHash2")
                        .HasColumnType("numeric(20,0)");
            ...
            modelBuilder.Entity("FolderMail", b =>
                {
                    ...
                    b.HasKey("FolderId", "MailsId");

                    b.HasIndex("MailsId");

                    b.ToTable("FolderMail");
                });
            ...
            modelBuilder.Entity("Backend.Models.Mail", b =>
                {
                    ...
                    b.HasOne("Backend.Models.Mail", "Reply")
                        .WithOne("RepliedFrom")
                        .HasForeignKey("Backend.Models.Mail", "ReplyId")
                        .OnDelete(DeleteBehavior.Cascade);
