...
services:
  ...
  backend:
    ...
    environment:
      ...
      # SAVEMAIL__Logging__LogLevel__Backend: # The logging level for all services of the Backend. If empty it will default to the default logging value of "Information"
      # SAVEMAIL__Logging__LogLevel__Microsoft.AspNetCore: Information # The default logging level for the host application and endpoints. Uses the "Warning" value if not set.
  ...
  frontend:
    ...
    environment:
      PORT: "3000"
      HOST: "localhost" #The hostname of the frontend
